<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Редактирование отдела в организации "{{ $organization->name }}"
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <form method="post" action="{{ route('organizations.departments.update', [
                    $organization->id,
                    $department->id,
                ]) }}">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <x-text-input id="name" name="name" type="text"
                                      :value="$department->name" class="mt-1 block w-full"
